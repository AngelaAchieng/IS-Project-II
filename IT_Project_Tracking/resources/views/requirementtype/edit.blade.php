        ...
        <div class="col-lg-9 col-12 mx-auto position-relative">
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <h6 class="mb-0">Edit Requirement Type</h6>
                </div>
                <div class="card-body pt-2">
                    ...
                    <div class="input-group input-group-outline mb-4">
                        <input type='text' value="{{$requirementtype->RequirementType_Name}}" required name="requirementtype_name" class="form-control">
                    </div>
                    <div class="d-flex justify-content-end mt-4">
                        <button type="submit" class="btn bg-gradient-dark m-0 ms-2">Update Requirement Type</button>
                    </div>
                </div>
            </div>
