            ...
            <div class="card">
                ...
                @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' value="{{$user->UserName}}" required name="users_names" class="form-control" placeholder="Enter First Name">
                        <label>Email</label>
                        <input type='string' value="{{$user->Email}}" pattern='[A-Za-z0-9\._%+\-]+@[A-Za-z0-9\.\-]+\.[A-Za-z]{2,}' required name="email" class="form-control" placeholder="Enter Email">
